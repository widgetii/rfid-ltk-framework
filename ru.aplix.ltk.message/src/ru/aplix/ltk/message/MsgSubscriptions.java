...
/**
 * Message message subscriptions list.
 *
 * <p>Can be used internally by message producers to maintain the subscriptions
 * list and to send the messages to all subscribed consumers.</p>
 *
 ...
 */
public abstract class MsgSubscriptions<H extends MsgHandle<H, M>, M> {
	 ...
	 *
	 * <p>By default invokes the {@link #subscribed(MsgHandle)} method.</p>
	 *
	 ...
	 * {@link #firstSubscribed(MsgHandle)} method is invoked instead.</p>
	 *
	 * <p>This method should be as small as possible, as it is invoked when
	 * this subscriptions are write locked.</p>
	 *
	 ...
	 * {@link #lastUnsubscribed(MsgHandle)} method is invoked instead.</p>
	 *
	 * <p>This method should be as small as possible, as it is invoked when
	 * this subscriptions are write locked.</p>
	 *
	 ...
	 *
	 * <p>By default invokes the {@link #unsubscribed(MsgHandle)} method.</p>
	 *
	 * <p>This method should be as small as possible, as it is invoked when
	 * this subscriptions are write locked.</p>
	 *
